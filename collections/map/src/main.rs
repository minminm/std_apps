...
// use test_helpers::test_rng;

// fn _assert_hashmap_is_unwind_safe() {
//     fn assert_unwind_safe<T: panic::UnwindSafe>() {}
...
fn test_raw_entry() {
    use std::collections::hash_map::RawEntryMut::{Occupied, Vacant};
...
pub mod test_extract_if {
    ...
    fn consuming_nothing() {
        ...
        assert!(map.extract_if(|_, _| false).eq_sorted(iter::empty()));
        assert_eq!(map.len(), 3);
    }
    ...
    pub fn test() {
        ...
        mutating_and_keeping();
        
        mutating_and_removing();
